...
public class ContactFormTest {
    ...
    public void saveEventHasCorrectValues() {
        ...
        form.firstName.setValue("Rifqi");
        form.lastName.setValue("Muhammad Aziz");
        form.email.setValue("rifqimuhammadaziz@gmail.com");
        ...
        Assert.assertEquals("Rifqi", saved.getFirstName());
        Assert.assertEquals("Muhammad Aziz", saved.getLastName());
        Assert.assertEquals("rifqimuhammadaziz@gmail.com", saved.getEmail());
